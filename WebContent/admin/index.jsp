...
<body data-type="index">
	...
	<div class="tpl-page-container tpl-page-header-fixed">
		...
		<div class="tpl-content-wrapper">
			<div class="tpl-content-page-title">西瓜 APP 后台管理中心</div>
			...
			<div class="tpl-content-scope">
				<div class="note note-info">
					<h3>
						西瓜 APP 为梦而生，引领未来! <span class="close" data-close="note"></span>
					</h3>
					<p>西瓜
						APP是一款在线教育评测安卓软件，分别由学生端、教师端两大模块为核心，通过学生给老师的评价以及老师之间的互评达到评测效果，实现在线评测</p>
					<p>
						<span class="label label-danger">提示:</span> 西瓜
						APP为测试软件只适用于项目测试，不用于商业活动！如有雷同纯属巧合，切记：抄袭 谢谢合作
					</p>
				</div>
			</div>
			<div class="row">
